...
public:
    void init() {
        ...
        // 4. Configure Channels & Result Registers using XMClib Group functions
        ...
        // Temp: Group 0 CH 1 -> RES[7], Aliased to Channel 7 [source: 24]
        ...
        // Iout: Group 0 CH 0 -> RES[9] [source: 23]
    ...
    inline Telemetry process(uint16_t rawVin, uint16_t rawIin, uint16_t rawIout, uint16_t rawVref, uint16_t rawTemp, bool dip3State = false) {
        ...
        // 1. xFactor = 2.5 / TempVref [source: 22]
